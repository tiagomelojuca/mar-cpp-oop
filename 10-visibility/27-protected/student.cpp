...
void college::Student::printHello() {
    ...
    // NOTE:
    // in the header file, we declared that printHello()
    // is a static method. Thus, it could handle only static members
    // cout << "Hello, World!" << nextId << endl; -> good, nextId is static
    // cout << "Hello, World!" << id << endl; -> bad, id is not static
};
